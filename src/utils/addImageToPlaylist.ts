...
async function sendImageToPlaylistAPI(imgFile: string|ArrayBuffer|null, playlistID: string) {
        if (typeof imgFile === "string") {
            ...
            const response = await axios.put(`https://api.spotify.com/v1/playlists/${playlistID}/images`, body, headers)
